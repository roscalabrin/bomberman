...
class Game {
  ...
  configPlayers() {
    ...
    const coordsOne = this.getStartingLocations()[mapName]['playerOne']
    const coordsTwo = this.getStartingLocations()[mapName]['playerTwo']
    this.setStartingLocations(coordsOne, coordsTwo)
  }

  getStartingLocations() {
    return {
      DefaultMap: { playerOne: { x: 35, y: 35 }, playerTwo: { x: 1120, y: 560 } },
      SmallMap: { playerOne: { x: 280, y: 140 }, playerTwo: { x: 875, y: 455 } }
    }
  }
